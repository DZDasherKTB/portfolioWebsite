    ...
    <>
      <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 z-50 flex items-center justify-center slider">
        <div className="text-white text-4xl">
          Follow Me on{" "}
          <span className="text-red-500 text-3xl text-nowrap">
            Social Media
          </span>
        </div>
      </div>
            ...
            <div className="flex w-[350%] h-full">
              <div className="w-[100vw] h-[85vh] bg-slate-700 text-white p-8 rounded-xl snap-start mx-2 mt-2">
                ...
                <p className="text-lg text-white">
                  My GitHub profile is where you can find my open-source
                  projects, contributions, and the code for various personal and
                  academic projects.
                </p>
                <a
              ...
              <div className="w-[100vw] h-[85vh] bg-slate-700 text-white p-8 rounded-xl snap-start mx-2 mt-2">
                ...
                <p className="text-lg text-white">
                  ...
                  projects, events, and more personal moments that I share with
                  my followers.
                </p>
                <a
              ...
              <div className="w-[100vw] h-[85vh] bg-slate-700 text-white p-8 rounded-xl snap-start mx-2 mt-2">
                ...
                <p className="text-lg text-white">
                  ...
                  upcoming projects. We can also collaborate on interesting
                  ideas!
                </p>
                <a
